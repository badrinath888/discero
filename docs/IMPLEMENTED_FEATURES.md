...
The frontend has 23 focused Vitest/React Testing Library regression tests: 10 cover Transactions bulk category/delete, Undo timing and replacement, stale selections, error details, and Potential Duplicates compatibility; 5 cover authentication recovery; 2 cover monthly Budget copy/delete and overspent rendering; and 6 cover Accounts/Plaid Sync Now success/loading/failure, last-sync display, disconnect confirmation, and reconnect-required presentation. All provider and API boundaries are mocked.
